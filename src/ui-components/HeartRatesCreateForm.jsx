...
export default function HeartRatesCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setMinimum(initialValues.minimum);
    setMaximum(initialValues.maximum);
    setMeanAverage(initialValues.meanAverage);
    setDateTim(initialValues.dateTim);
    setErrors({});
  };
  const validations = {
    minimum: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new HeartRates(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "HeartRatesCreateForm")}
      {...rest}
    >
      <TextField
        label="Minimum"
